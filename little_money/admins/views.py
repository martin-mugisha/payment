...
def order_detail(request, pk):
    ...
    "pay_time": notification.pay_time.strftime('%Y-%m-%d %H:%M:%S') if notification.pay_time else '',
    "processed": notification.processed,
    "processed_at": notification.processed_at.strftime('%Y-%m-%d %H:%M:%S') if notification.processed_at else '',
    "pay_message": notification.pay_message or '',
