...
urlpatterns = [
    ...
    path('transactions/statement/', download_statement, name='download_statement'),
    path('transactions/receipt/<str:transaction_id>/', download_receipt, name='download_receipt'),
